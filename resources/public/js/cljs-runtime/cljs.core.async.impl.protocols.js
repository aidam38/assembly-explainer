...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_45723 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_45723(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_45724 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_45724(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_45725 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_45725(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_45726 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_45726(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_45727 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_45727(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_45728 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_45728(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_45729 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_45729(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_45730 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_45730(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_45731 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_45731(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_45732 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_45732(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_45733 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_45733(b);
}
});
