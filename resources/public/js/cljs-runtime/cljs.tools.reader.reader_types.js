...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45781 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45781(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45782 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45782(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45784 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45784(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45786 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45786(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45787 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45787(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45788 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45788(reader);
}
});
...
var G__45798 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45799 = s.append(c);
c = G__45798;
s = G__45799;
continue;
}
