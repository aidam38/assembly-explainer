...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__41706){
...
var vec__41710 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41710,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41710,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41710,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_41899 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_41899(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_41906 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_41906(a,b);
}
});
...
var fexpr__41834 = (function (){var G__41836 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41836__$1)].join('')));

}
})();
return (fexpr__41834.cljs$core$IFn$_invoke$arity$2 ? fexpr__41834.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__41834.call(null,a,b));
}));
/**
