...
var G__46458 = clojure.zip.node(loc);
var fexpr__46457 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__46457.cljs$core$IFn$_invoke$arity$1 ? fexpr__46457.cljs$core$IFn$_invoke$arity$1(G__46458) : fexpr__46457.call(null,G__46458));
});
/**
...
var G__46461 = clojure.zip.node(loc);
var fexpr__46460 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__46460.cljs$core$IFn$_invoke$arity$1 ? fexpr__46460.cljs$core$IFn$_invoke$arity$1(G__46461) : fexpr__46460.call(null,G__46461));
} else {
...
var fexpr__46462 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__46462.cljs$core$IFn$_invoke$arity$2 ? fexpr__46462.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__46462.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__46467 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46467,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46467,(1),null);
var vec__46470 = clojure.zip.children(loc);
...
var vec__46476 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46476,(0),null);
var map__46479 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46476,(1),null);
var map__46479__$1 = cljs.core.__destructure_map(map__46479);
var path = map__46479__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46479__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46479__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46479__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46479__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46479__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__46485 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46485,(0),null);
var map__46488 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46485,(1),null);
var map__46488__$1 = cljs.core.__destructure_map(map__46488);
var path = map__46488__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46488__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__46489 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46488__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__46496 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46496,(0),null);
...
var path = map__46499__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46499__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46499__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
return r;
} else {
...
var vec__46503 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46503,(0),null);
var map__46506 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46503,(1),null);
var map__46506__$1 = cljs.core.__destructure_map(map__46506);
var path = map__46506__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46506__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46506__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
...
var vec__46512 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46512,(0),null);
var map__46515 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46512,(1),null);
var map__46515__$1 = cljs.core.__destructure_map(map__46515);
var path = map__46515__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46515__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46515__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__46519 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46519,(0),null);
var map__46522 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46519,(1),null);
var map__46522__$1 = cljs.core.__destructure_map(map__46522);
var path = map__46522__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46522__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__46528 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46528,(0),null);
var map__46531 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46528,(1),null);
var map__46531__$1 = cljs.core.__destructure_map(map__46531);
var path = map__46531__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46531__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__46532 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46532,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46532,(1),null);
...
var len__4818__auto___46558 = arguments.length;
var i__4819__auto___46559 = (0);
while(true){
if((i__4819__auto___46559 < len__4818__auto___46558)){
args__4824__auto__.push((arguments[i__4819__auto___46559]));

var G__46560 = (i__4819__auto___46559 + (1));
i__4819__auto___46559 = G__46560;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq46535){
var G__46536 = cljs.core.first(seq46535);
var seq46535__$1 = cljs.core.next(seq46535);
var G__46537 = cljs.core.first(seq46535__$1);
var seq46535__$2 = cljs.core.next(seq46535__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46536,G__46537,seq46535__$2);
}));
...
var temp__5752__auto__ = clojure.zip.left(loc);
if(cljs.core.truth_(temp__5752__auto__)){
var lloc = temp__5752__auto__;
var loc__$1 = lloc;
while(true){
var temp__5752__auto____$1 = (function (){var and__4210__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__4210__auto__)){
...
var child = temp__5752__auto____$1;
var G__46567 = clojure.zip.rightmost(child);
loc__$1 = G__46567;
continue;
} else {
return loc__$1;
...
var vec__46547 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46547,(0),null);
var map__46550 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46547,(1),null);
var map__46550__$1 = cljs.core.__destructure_map(map__46550);
var path = map__46550__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46550__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46550__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46550__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46550__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
while(true){
var temp__5752__auto__ = (function (){var and__4210__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__4210__auto__)){
return clojure.zip.down(loc__$1);
} else {
return and__4210__auto__;
...
var G__46574 = clojure.zip.rightmost(child);
loc__$1 = G__46574;
continue;
} else {
return loc__$1;
