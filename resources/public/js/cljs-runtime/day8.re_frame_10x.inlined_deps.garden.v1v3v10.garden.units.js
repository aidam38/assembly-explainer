 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__43609,right){
var map__43612 = p__43609;
var map__43612__$1 = cljs.core.__destructure_map(map__43612);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43612__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43612__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var temp__5754__auto__ = cljs.core.re_matches(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.unit_re,s);
if(cljs.core.truth_(temp__5754__auto__)){
var vec__43619 = temp__5754__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43619,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43619,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43619,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43629__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__43630 = u(y);
var map__43630__$1 = cljs.core.__destructure_map(map__43630);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43630__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__43738__delegate = function (x,y,more){
...
var G__43738 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__43739__i = 0, G__43739__a = new Array(arguments.length -  2);
while (G__43739__i < G__43739__a.length) {G__43739__a[G__43739__i] = arguments[G__43739__i + 2]; ++G__43739__i;}
  more = new cljs.core.IndexedSeq(G__43739__a,0,null);
} 
return G__43738__delegate.call(this,x,y,more);};
G__43738.cljs$lang$maxFixedArity = 2;
G__43738.cljs$lang$applyTo = (function (arglist__43740){
var x = cljs.core.first(arglist__43740);
arglist__43740 = cljs.core.next(arglist__43740);
var y = cljs.core.first(arglist__43740);
var more = cljs.core.rest(arglist__43740);
return G__43738__delegate(x,y,more);
});
...
G__43742 = new cljs.core.IndexedSeq(G__43743__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__43742);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43651__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__43652 = u(y);
var map__43652__$1 = cljs.core.__destructure_map(map__43652);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43652__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
var more = null;
if (arguments.length > 2) {
var G__43745__i = 0, G__43745__a = new Array(arguments.length -  2);
while (G__43745__i < G__43745__a.length) {G__43745__a[G__43745__i] = arguments[G__43745__i + 2]; ++G__43745__i;}
  more = new cljs.core.IndexedSeq(G__43745__a,0,null);
} 
...
var x = cljs.core.first(arglist__43746);
arglist__43746 = cljs.core.next(arglist__43746);
var y = cljs.core.first(arglist__43746);
var more = cljs.core.rest(arglist__43746);
...
var G__43747 = null;
if (arguments.length > 2) {
var G__43749__i = 0, G__43749__a = new Array(arguments.length -  2);
while (G__43749__i < G__43749__a.length) {G__43749__a[G__43749__i] = arguments[G__43749__i + 2]; ++G__43749__i;}
G__43747 = new cljs.core.IndexedSeq(G__43749__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__43747);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43664__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__43665 = u(y);
var map__43665__$1 = cljs.core.__destructure_map(map__43665);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43665__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var more = null;
if (arguments.length > 2) {
var G__43754__i = 0, G__43754__a = new Array(arguments.length -  2);
while (G__43754__i < G__43754__a.length) {G__43754__a[G__43754__i] = arguments[G__43754__i + 2]; ++G__43754__i;}
  more = new cljs.core.IndexedSeq(G__43754__a,0,null);
} 
...
var x = cljs.core.first(arglist__43756);
arglist__43756 = cljs.core.next(arglist__43756);
var y = cljs.core.first(arglist__43756);
var more = cljs.core.rest(arglist__43756);
...
var G__43757 = null;
if (arguments.length > 2) {
var G__43758__i = 0, G__43758__a = new Array(arguments.length -  2);
while (G__43758__i < G__43758__a.length) {G__43758__a[G__43758__i] = arguments[G__43758__i + 2]; ++G__43758__i;}
G__43757 = new cljs.core.IndexedSeq(G__43758__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__43757);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43668__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__43669 = u(y);
var map__43669__$1 = cljs.core.__destructure_map(map__43669);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43669__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
var x = cljs.core.first(arglist__43763);
arglist__43763 = cljs.core.next(arglist__43763);
var y = cljs.core.first(arglist__43763);
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__43764);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
