...
return [(function (){var pred__41230 = cljs.core.instance_QMARK_;
var expr__41231 = reactive_val;
if(cljs.core.truth_((pred__41230.cljs$core$IFn$_invoke$arity$2 ? pred__41230.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__41231) : pred__41230.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__41231)))){
return "ra";
} else {
if(cljs.core.truth_((pred__41230.cljs$core$IFn$_invoke$arity$2 ? pred__41230.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__41231) : pred__41230.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__41231)))){
return "rc";
} else {
if(cljs.core.truth_((pred__41230.cljs$core$IFn$_invoke$arity$2 ? pred__41230.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__41231) : pred__41230.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__41231)))){
return "rx";
} else {
if(cljs.core.truth_((pred__41230.cljs$core$IFn$_invoke$arity$2 ? pred__41230.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__41231) : pred__41230.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__41231)))){
return "tr";
} else {
return "other";
}
