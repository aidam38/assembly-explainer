...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__41768){
var map__41769 = p__41768;
var map__41769__$1 = cljs.core.__destructure_map(map__41769);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41769__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41769__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41769__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41769__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__41772_41801 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__41773_41802 = null;
var count__41774_41803 = (0);
var i__41775_41804 = (0);
while(true){
if((i__41775_41804 < count__41774_41803)){
var vec__41786_41805 = chunk__41773_41802.cljs$core$IIndexed$_nth$arity$2(null,i__41775_41804);
var k_41806 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41786_41805,(0),null);
var cb_41807 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41786_41805,(1),null);
try{var G__41790_41808 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_41807.cljs$core$IFn$_invoke$arity$1 ? cb_41807.cljs$core$IFn$_invoke$arity$1(G__41790_41808) : cb_41807.call(null,G__41790_41808));
}catch (e41789){var e_41809 = e41789;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_41806,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_41809], 0));
}

var G__41810 = seq__41772_41801;
var G__41811 = chunk__41773_41802;
var G__41812 = count__41774_41803;
var G__41813 = (i__41775_41804 + (1));
seq__41772_41801 = G__41810;
chunk__41773_41802 = G__41811;
count__41774_41803 = G__41812;
i__41775_41804 = G__41813;
continue;
} else {
var temp__5754__auto___41814 = cljs.core.seq(seq__41772_41801);
if(temp__5754__auto___41814){
var seq__41772_41815__$1 = temp__5754__auto___41814;
if(cljs.core.chunked_seq_QMARK_(seq__41772_41815__$1)){
var c__4638__auto___41816 = cljs.core.chunk_first(seq__41772_41815__$1);
var G__41817 = cljs.core.chunk_rest(seq__41772_41815__$1);
var G__41818 = c__4638__auto___41816;
var G__41819 = cljs.core.count(c__4638__auto___41816);
var G__41820 = (0);
seq__41772_41801 = G__41817;
chunk__41773_41802 = G__41818;
count__41774_41803 = G__41819;
i__41775_41804 = G__41820;
continue;
} else {
var vec__41792_41821 = cljs.core.first(seq__41772_41815__$1);
var k_41822 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41792_41821,(0),null);
var cb_41823 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41792_41821,(1),null);
try{var G__41796_41824 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_41823.cljs$core$IFn$_invoke$arity$1 ? cb_41823.cljs$core$IFn$_invoke$arity$1(G__41796_41824) : cb_41823.call(null,G__41796_41824));
}catch (e41795){var e_41825 = e41795;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_41822,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_41825], 0));
}

var G__41826 = cljs.core.next(seq__41772_41815__$1);
var G__41827 = null;
var G__41828 = (0);
var G__41829 = (0);
seq__41772_41801 = G__41826;
chunk__41773_41802 = G__41827;
count__41774_41803 = G__41828;
i__41775_41804 = G__41829;
continue;
}
} else {
}
