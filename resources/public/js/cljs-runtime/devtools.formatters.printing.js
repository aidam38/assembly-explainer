...
var len__4818__auto___43321 = arguments.length;
var i__4819__auto___43322 = (0);
while(true){
if((i__4819__auto___43322 < len__4818__auto___43321)){
args__4824__auto__.push((arguments[i__4819__auto___43322]));

var G__43323 = (i__4819__auto___43322 + (1));
i__4819__auto___43322 = G__43323;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43273){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43274,G__43275,seq43273__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43298_SHARP_){
return (!((cljs.core.meta(p1__43298_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43302__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43306){var _e__42344__auto__ = e43306;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e43308){var _e__42344__auto__ = e43308;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43310 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43311 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43311);

try{var map__43312 = opts;
var map__43312__$1 = cljs.core.__destructure_map(map__43312);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43312__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43310);
}});
...
var temp__5752__auto___43328 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5752__auto___43328)){
var managed_print_level_43329 = temp__5752__auto___43328;
var _STAR_print_level_STAR__orig_val__43314_43330 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43315_43331 = managed_print_level_43329;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43315_43331);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43313_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43313_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43314_43330);
}} else {
job_fn();
}
