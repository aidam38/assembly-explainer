...
var map__42568 = top_item;
var map__42568__$1 = cljs.core.__destructure_map(map__42568);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42568__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42568__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42568__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e42567){var _e = e42567;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5752__auto___42703 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5752__auto___42703)){
var seen_errors_42704 = temp__5752__auto___42703;
if(cljs.core.truth_(seen_errors_42704.has(self))){
} else {
seen_errors_42704.add(self);

var temp__5754__auto___42707 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5754__auto___42707)){
var sense_42708 = temp__5754__auto___42707;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42708)].join(''));
} else {
}
}
} else {
