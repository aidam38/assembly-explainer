...
var o42782 = temp__5752__auto__;
var temp__5752__auto____$1 = (o42782["core"]);
if(cljs.core.truth_(temp__5752__auto____$1)){
var o42783 = temp__5752__auto____$1;
return (o42783["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42317__auto__ = f;
return (o__42317__auto__["toString"]).call(o__42317__auto__);
} else {
return "";
}
}catch (e42786){var _ = e42786;
return "";
}});
...
try{var o__42317__auto___43154 = t;
(o__42317__auto___43154["cljs$lang$ctorPrWriter"]).call(o__42317__auto___43154,t,writer);
}catch (e42787){var __43155 = e42787;
}
...
var char_code = (function (){var o__42317__auto__ = (new String(char$));
return (o__42317__auto__["charCodeAt"]).call(o__42317__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42317__auto__ = String;
return (o__42317__auto__["fromCharCode"]).call(o__42317__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42810 = num_code;
switch (G__42810) {
case (1):
return (185);
...
var o__42317__auto__ = String;
return (o__42317__auto__["fromCharCode"]).call(o__42317__auto__,superscript_code);
});
/**
...
}catch (e42819){var _e__42344__auto__ = e42819;
return false;
}})())){
...
var vec__42821 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42821,(0),null);
...
var or__4212__auto__ = (function (){var temp__5752__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5752__auto__)){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42835){
var vec__42836 = p__42835;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42836,(0),null);
...
var G__43164 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43165 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43164;
remaining_tokens = G__43165;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42833){
var G__42834 = cljs.core.first(seq42833);
var seq42833__$1 = cljs.core.next(seq42833);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42834,seq42833__$1);
}));
...
var vec__42847 = cljs.core.split_with((function (p1__42841_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42841_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42847,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42847,(1),null);
...
var G__43167 = cljs.core.rest(remaining_tokens);
var G__43168 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
...
var vec__42864 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42864,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42864,(1),null);
var vec__42867 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42867,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42867,(1),null);
var vec__42870 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42870,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42870,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42870,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42870,(3),null);
...
var vec__42885 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42885,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42885,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42885,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42885,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42885,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42885,(5),null);
...
if(cljs.core.truth_(temp__5752__auto__)){
var vec__42893 = temp__5752__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42893,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42893,(1),null);
var vec__42896 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42896,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42896,(1),null);
...
var G__43195 = (arity + (1));
var G__43196 = (function (){var temp__5752__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5752__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42974){
var vec__42976 = p__42974;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42976,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42976,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43006_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__43006_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43007_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__43007_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___43208 = arguments.length;
var i__4819__auto___43209 = (0);
while(true){
if((i__4819__auto___43209 < len__4818__auto___43208)){
args__4824__auto__.push((arguments[i__4819__auto___43209]));

var G__43210 = (i__4819__auto___43209 + (1));
i__4819__auto___43209 = G__43210;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43014){
var vec__43015 = p__43014;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43015,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43012){
var G__43013 = cljs.core.first(seq43012);
var seq43012__$1 = cljs.core.next(seq43012);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43013,seq43012__$1);
}));
...
var map__43059 = options;
var map__43059__$1 = cljs.core.__destructure_map(map__43059);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43059__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43059__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43059__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43059__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43060 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(5),null);
...
var o__42317__auto__ = f;
return (o__42317__auto__["getBasis"]).call(o__42317__auto__);
});
/**
...
}catch (e43076){var _e__42344__auto__ = e43076;
...
var G__43238 = (obj[cljs.core.first(path)]);
var G__43239 = cljs.core.rest(path);
obj = G__43238;
path = G__43239;
continue;
} else {
...
var _STAR_ = (function (accum,p__43124){
var vec__43125 = p__43124;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43125,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43125,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43137){
var vec__43138 = p__43137;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43138,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43138,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43138,(2),null);
...
var post_process = (function (p__43146){
var vec__43147 = p__43146;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43147,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43147,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43142_SHARP_){
return (obj[cljs.core.first(p1__43142_SHARP_)]);
}),sorted_matches);
