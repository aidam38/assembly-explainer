...
var G__53193 = o;
goog.object.set(G__53193,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__53194 = o;
goog.object.set(G__53194,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__53215__i = 0, G__53215__a = new Array(arguments.length -  0);
while (G__53215__i < G__53215__a.length) {G__53215__a[G__53215__i] = arguments[G__53215__i + 0]; ++G__53215__i;}
  args = new cljs.core.IndexedSeq(G__53215__a,0,null);
} 
return G__53214__delegate.call(this,args);};
G__53214.cljs$lang$maxFixedArity = 0;
G__53214.cljs$lang$applyTo = (function (arglist__53216){
var args = cljs.core.seq(arglist__53216);
...
var G__53195 = props;
var G__53195__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53195,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53195);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53195__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53196 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53196,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53196;
}
})(),id_class);
...
var G__53197 = (cljs.core.count(argv) - first_child);
switch (G__53197) {
case (0):
...
var vec__53198 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53198,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53198,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53198,(2),null);
...
var temp__5758__auto___53218 = reagent.impl.util.react_key_from_vec(v);
if((temp__5758__auto___53218 == null)){
} else {
var key_53219 = temp__5758__auto___53218;
(jsprops.key = key_53219);
}
...
var temp__5758__auto___53220 = reagent.impl.util.react_key_from_vec(v);
if((temp__5758__auto___53220 == null)){
} else {
var key_53221 = temp__5758__auto___53220;
(jsprops.key = key_53221);
}
...
var temp__5758__auto___53222 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5758__auto___53222 == null)){
} else {
var key_53223 = temp__5758__auto___53222;
(jsprops.key = key_53223);
}
...
var temp__5758__auto___53224 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5758__auto___53224 == null)){
} else {
var key_53225 = temp__5758__auto___53224;
(jsprops.key = key_53225);
}
...
var temp__5758__auto___53226 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5758__auto___53226 == null)){
} else {
var key_53227 = temp__5758__auto___53226;
(jsprops.key = key_53227);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53201_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__53201_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__53202 = reagent.ratom.check_derefs((function (){
...
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53202,(1),null);
...
break;
default:
var G__53229 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__53230 = compiler;
v = G__53229;
compiler = G__53230;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template53208 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template53208 = (function (opts,id,fn_to_element,parse_fn,meta53209){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template53208.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53210,meta53209__$1){
var self__ = this;
var _53210__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template53208(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta53209__$1));
}));

(reagent.impl.template.t_reagent$impl$template53208.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53210){
var self__ = this;
var _53210__$1 = this;
return self__.meta53209;
}));

(reagent.impl.template.t_reagent$impl$template53208.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template53208.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template53208.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template53208.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template53208.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template53208.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta53209","meta53209",-1203680892,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template53208.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template53208.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template53208");

(reagent.impl.template.t_reagent$impl$template53208.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template53208");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template53208.
 */
reagent.impl.template.__GT_t_reagent$impl$template53208 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template53208(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta53209){
return (new reagent.impl.template.t_reagent$impl$template53208(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta53209));
});

}

return (new reagent.impl.template.t_reagent$impl$template53208(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
