...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k45973,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45973,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__46033){
var vec__46037 = p__46033;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46037,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46037,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45972){
var self__ = this;
var G__45972__$1 = this;
return (new cljs.core.RecordIter((0),G__45972__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45976,other45977){
var self__ = this;
var this45976__$1 = this;
return (((!((other45977 == null)))) && ((((this45976__$1.constructor === other45977.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.s,other45977.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.__extmap,other45977.__extmap)))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k45973){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45973);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__45972){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__46086 = cljs.core.keyword_identical_QMARK_;
var expr__46087 = k__4470__auto__;
if(cljs.core.truth_((pred__46086.cljs$core$IFn$_invoke$arity$2 ? pred__46086.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__46087) : pred__46086.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__46087)))){
return (new rewrite_clj.node.comment.CommentNode(G__45972,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__45972),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__45972){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__45972,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__46004){
var extmap__4501__auto__ = (function (){var G__46119 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46004,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__46004)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46119);
} else {
return G__46119;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__46004),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
