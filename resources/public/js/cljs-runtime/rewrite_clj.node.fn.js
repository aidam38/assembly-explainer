...
var syms = (function (){var iter__4611__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__46179(s__46180){
return (new cljs.core.LazySeq(null,(function (){
var s__46180__$1 = s__46180;
while(true){
var temp__5754__auto__ = cljs.core.seq(s__46180__$1);
if(temp__5754__auto__){
var s__46180__$2 = temp__5754__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46180__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__46180__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__46182 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__46181 = (0);
while(true){
if((i__46181 < size__4610__auto__)){
var i = cljs.core._nth(c__4609__auto__,i__46181);
...
cljs.core.chunk_append(b__46182,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__46261 = (i__46181 + (1));
i__46181 = G__46261;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46182),rewrite_clj$node$fn$fn_walk_$_iter__46179(cljs.core.chunk_rest(s__46180__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46182),null);
}
} else {
var i = cljs.core.first(s__46180__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__46179(cljs.core.rest(s__46180__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__46178_SHARP_){
var or__4212__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__46178_SHARP_);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return p1__46178_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k46218,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46218,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__46231){
var vec__46233 = p__46231;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46233,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46233,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46217){
var self__ = this;
var G__46217__$1 = this;
return (new cljs.core.RecordIter((0),G__46217__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46219,other46220){
var self__ = this;
var this46219__$1 = this;
return (((!((other46220 == null)))) && ((((this46219__$1.constructor === other46220.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46219__$1.children,other46220.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46219__$1.__extmap,other46220.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k46218){
var self__ = this;
var this__4468__auto____$1 = this;
var G__46249 = k46218;
var G__46249__$1 = (((G__46249 instanceof cljs.core.Keyword))?G__46249.fqn:null);
switch (G__46249__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46218);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__46217){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__46250 = cljs.core.keyword_identical_QMARK_;
var expr__46251 = k__4470__auto__;
if(cljs.core.truth_((pred__46250.cljs$core$IFn$_invoke$arity$2 ? pred__46250.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46251) : pred__46250.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46251)))){
return (new rewrite_clj.node.fn.FnNode(G__46217,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__46217),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__46217){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__46217,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__46221){
var extmap__4501__auto__ = (function (){var G__46257 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46221,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__46221)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46257);
} else {
return G__46257;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46221),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
