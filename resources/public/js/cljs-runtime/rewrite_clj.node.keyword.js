...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k46024,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46024,else__4464__auto__);
...
return (new cljs.core.RecordIter((0),G__46023__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var temp__5752__auto__ = cljs.core.namespace(self__.k);
if(cljs.core.truth_(temp__5752__auto__)){
var nspace = temp__5752__auto__;
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k46024){
var self__ = this;
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__46023){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__46127 = cljs.core.keyword_identical_QMARK_;
var expr__46128 = k__4470__auto__;
if(cljs.core.truth_((pred__46127.cljs$core$IFn$_invoke$arity$2 ? pred__46127.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__46128) : pred__46127.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__46128)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__46023,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46127.cljs$core$IFn$_invoke$arity$2 ? pred__46127.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__46128) : pred__46127.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__46128)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__46023,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__46023),null));
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__46023){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__46023,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__46028){
var extmap__4501__auto__ = (function (){var G__46131 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46028,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__46028)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46131);
} else {
return G__46131;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__46028),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__46028),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
...
var len__4818__auto___46183 = arguments.length;
var i__4819__auto___46184 = (0);
while(true){
if((i__4819__auto___46184 < len__4818__auto___46183)){
args__4824__auto__.push((arguments[i__4819__auto___46184]));

var G__46185 = (i__4819__auto___46184 + (1));
i__4819__auto___46184 = G__46185;
continue;
} else {
}
break;
...
(rewrite_clj.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__46155){
var vec__46156 = p__46155;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46156,(0),null);
...
/** @this {Function} */
(rewrite_clj.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq46133){
var G__46134 = cljs.core.first(seq46133);
var seq46133__$1 = cljs.core.next(seq46133);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46134,seq46133__$1);
}));
