...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k46083,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46083,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__46168){
var vec__46169 = p__46168;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46169,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46169,(1),null);
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46082){
var self__ = this;
var G__46082__$1 = this;
return (new cljs.core.RecordIter((0),G__46082__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"lines","lines",-700165781)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46084,other46085){
var self__ = this;
var this46084__$1 = this;
return (((!((other46085 == null)))) && ((((this46084__$1.constructor === other46085.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46084__$1.lines,other46085.lines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46084__$1.__extmap,other46085.__extmap)))))));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k46083){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46083);

}
}));

(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__46082){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__46190 = cljs.core.keyword_identical_QMARK_;
var expr__46191 = k__4470__auto__;
if(cljs.core.truth_((pred__46190.cljs$core$IFn$_invoke$arity$2 ? pred__46190.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lines","lines",-700165781),expr__46191) : pred__46190.call(null,new cljs.core.Keyword(null,"lines","lines",-700165781),expr__46191)))){
return (new rewrite_clj.node.stringz.StringNode(G__46082,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.stringz.StringNode(self__.lines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__46082),null));
}
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__46082){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.stringz.StringNode(self__.lines,G__46082,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.stringz.map__GT_StringNode = (function rewrite_clj$node$stringz$map__GT_StringNode(G__46125){
var extmap__4501__auto__ = (function (){var G__46205 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46125,new cljs.core.Keyword(null,"lines","lines",-700165781));
if(cljs.core.record_QMARK_(G__46125)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46205);
} else {
return G__46205;
}
})();
return (new rewrite_clj.node.stringz.StringNode(new cljs.core.Keyword(null,"lines","lines",-700165781).cljs$core$IFn$_invoke$arity$1(G__46125),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
