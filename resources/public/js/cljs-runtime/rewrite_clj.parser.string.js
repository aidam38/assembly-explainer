...
if((c === "\n")){
var G__46444 = escape_QMARK_;
var G__46445 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__46444;
lines = G__46445;
continue;
} else {
buf.append(c);

var G__46446 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__46447 = lines;
escape_QMARK_ = G__46446;
lines = G__46447;
continue;
...
var G__46436 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__46436) : rewrite_clj.node.string_node.call(null,G__46436));
});
...
var G__46438 = cljs.core.re_pattern(regex);
var G__46439 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__46438,G__46439) : rewrite_clj.node.token_node.call(null,G__46438,G__46439));
});
