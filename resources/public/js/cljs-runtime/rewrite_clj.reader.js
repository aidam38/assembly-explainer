...
var i__4819__auto___46371 = (0);
while(true){
if((i__4819__auto___46371 < len__4818__auto___46370)){
args__4824__auto__.push((arguments[i__4819__auto___46371]));

var G__46372 = (i__4819__auto___46371 + (1));
i__4819__auto___46371 = G__46372;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq46304){
var G__46305 = cljs.core.first(seq46304);
var seq46304__$1 = cljs.core.next(seq46304);
var G__46306 = cljs.core.first(seq46304__$1);
var seq46304__$2 = cljs.core.next(seq46304__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46305,G__46306,seq46304__$2);
}));
...
while(true){
var temp__5752__auto__ = (rewrite_clj.reader.read_char.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.reader.read_char.cljs$core$IFn$_invoke$arity$1(reader) : rewrite_clj.reader.read_char.call(null,reader));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__46332_SHARP_){
return (((p1__46332_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__46332_SHARP_)));
...
while(true){
if((c < n)){
var temp__5752__auto__ = (read_fn.cljs$core$IFn$_invoke$arity$1 ? read_fn.cljs$core$IFn$_invoke$arity$1(reader) : read_fn.call(null,reader));
if(cljs.core.truth_(temp__5752__auto__)){
var v = temp__5752__auto__;
var G__46386 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__46387 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__46386;
vs = G__46387;
continue;
} else {
