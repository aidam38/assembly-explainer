...
var temp__5752__auto__ = rewrite_clj.zip.move.down(zloc);
if(cljs.core.truth_(temp__5752__auto__)){
var n0 = temp__5752__auto__;
var G__46699 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__46699__$1 = (((G__46699 == null))?null:cljs.core.iterate((function (loc){
var temp__5752__auto____$1 = rewrite_clj.zip.move.right(loc);
if(cljs.core.truth_(temp__5752__auto____$1)){
var n = temp__5752__auto____$1;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n) : f.call(null,n));
} else {
return null;
}
}),G__46699));
var G__46699__$2 = (((G__46699__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__46699__$1));
var G__46699__$3 = (((G__46699__$2 == null))?null:cljs.core.last(G__46699__$2));
if((G__46699__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__46699__$3);
}
} else {
return zloc;
}
...
var temp__5752__auto__ = rewrite_clj.zip.move.right(loc);
if(cljs.core.truth_(temp__5752__auto__)){
var v0 = temp__5752__auto__;
var temp__5752__auto____$1 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v0) : f.call(null,v0));
if(cljs.core.truth_(temp__5752__auto____$1)){
var v = temp__5752__auto____$1;
var G__46712 = rewrite_clj.zip.move.right(v);
var G__46713 = rewrite_clj.zip.move.up(v);
loc = G__46712;
parent = G__46713;
continue;
} else {
var G__46714 = rewrite_clj.zip.move.right(v0);
var G__46715 = parent;
loc = G__46714;
parent = G__46715;
continue;
...
var G__46716 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__46717 = rewrite_clj.zip.move.up(v);
loc = G__46716;
parent = G__46717;
continue;
} else {
var G__46718 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__46719 = parent;
loc = G__46718;
parent = G__46719;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__46707 = zloc;
var G__46707__$1 = (((G__46707 == null))?null:rewrite_clj.zip.move.down(G__46707));
var G__46707__$2 = (((G__46707__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__46707__$1,k));
if((G__46707__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__46707__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__46708 = rewrite_clj.zip.move.down(zloc);
var G__46708__$1 = (((G__46708 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__46708));
if((G__46708__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__46708__$1);
}
})(),k);
}
});
...
var temp__5752__auto__ = rewrite_clj.zip.seqz.get(zloc,k);
if(cljs.core.truth_(temp__5752__auto__)){
var vloc = temp__5752__auto__;
