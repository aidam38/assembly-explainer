...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__46570,k,f){
var vec__46571 = p__46570;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46571,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46571,(1),null);
var loc = vec__46571;
...
var G__46610 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__46610;
continue;
}
break;
...
var zloc__$1 = zloc;
while(true){
var temp__5752__auto__ = clojure.zip.right(zloc__$1);
if(cljs.core.truth_(temp__5752__auto__)){
var rloc = temp__5752__auto__;
...
var G__46611 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__46611;
continue;
} else {
return zloc__$1;
...
var zloc__$1 = zloc;
while(true){
var temp__5752__auto__ = clojure.zip.left(zloc__$1);
if(cljs.core.truth_(temp__5752__auto__)){
...
var G__46612 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__46612;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__46581){
var vec__46582 = p__46581;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46582,(0),null);
var map__46585 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46582,(1),null);
var map__46585__$1 = cljs.core.__destructure_map(map__46585);
var path = map__46585__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46585__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__46582;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__46587){
var vec__46588 = p__46587;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46588,(0),null);
var map__46591 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46588,(1),null);
var map__46591__$1 = cljs.core.__destructure_map(map__46591);
var path = map__46591__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46591__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__46588;
if(cljs.core.seq(r)){
...
var vec__46599 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46599,(0),null);
var map__46603 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46599,(1),null);
var map__46603__$1 = cljs.core.__destructure_map(map__46603);
var path = map__46603__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46603__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46603__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46603__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46603__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
