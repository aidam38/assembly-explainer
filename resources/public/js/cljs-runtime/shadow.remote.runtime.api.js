...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47551 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47551(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_47552 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_47552(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_47553 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_47553(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_47555 = (function (thing,opts){
...
var meta_impl__4511__auto__ = temp__5752__auto__;
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_47555(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47557 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47557(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47558 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47558(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__47547,callback){
var map__47548 = p__47547;
var map__47548__$1 = cljs.core.__destructure_map(map__47548);
var input = map__47548__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47548__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47548__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
