...
var vec__48643 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__48652 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48652,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48652,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48643,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48643,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__48655){
var vec__48656 = p__48655;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48656,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48656,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48659,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48659,(1),null);
...
var vec__48663 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48663,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48663,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48663,(2),null);
var vec__48666 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48666,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48666,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48666,(2),null);
...
var G__48669 = special_option;
var G__48669__$1 = (((G__48669 instanceof cljs.core.Keyword))?G__48669.fqn:null);
switch (G__48669__$1) {
case "explain":
...
return zprint.core.fzprint_style(coll,(function (){var temp__5752__auto__ = new cljs.core.Keyword(null,"fn-name","fn-name",-766594004).cljs$core$IFn$_invoke$arity$1(actual_options);
if(cljs.core.truth_(temp__5752__auto__)){
var fn_name = temp__5752__auto__;
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__48673){
var vec__48674 = p__48673;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48674,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48674,(1),null);
...
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48681,(2),null);
...
var vec__48690 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48690,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48690,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48690,(2),null);
var tuple = vec__48690;
...
var G__48885 = cljs.core.next(style_vec);
var G__48886 = ends_w_blanks_QMARK_;
var G__48887 = tuple;
var G__48888 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__48885;
previous_ends_w_blanks_QMARK_ = G__48886;
previous_tuple = G__48887;
out = G__48888;
continue;
}
break;
...
var len__4818__auto___48894 = arguments.length;
var i__4819__auto___48895 = (0);
while(true){
if((i__4819__auto___48895 < len__4818__auto___48894)){
args__4824__auto__.push((arguments[i__4819__auto___48895]));

var G__48897 = (i__4819__auto___48895 + (1));
i__4819__auto___48895 = G__48897;
continue;
} else {
}
break;
...
var vec__48708 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48708,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48708,(1),null);
...
var result = (function (){var G__48711 = zprint.core.parse_string_all_options(rest_options);
var G__48712 = zprint.core.zprint_str_internal;
var G__48713 = ":parse-string-all? call";
var G__48714 = (function (){var G__48715 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__48715) : zprint.zutil.edn_STAR_.call(null,G__48715));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__48711,G__48712,G__48713,G__48714) : zprint.core.process_multiple_forms.call(null,G__48711,G__48712,G__48713,G__48714));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__48722 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48722,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48722,(1),null);
var cvec_wo_empty = cvec;
var focus_vec = (function (){var temp__5752__auto__ = new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options)));
if(cljs.core.truth_(temp__5752__auto__)){
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq48700){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48701,G__48702,seq48700__$2);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___48901 = arguments.length;
var i__4819__auto___48902 = (0);
while(true){
if((i__4819__auto___48902 < len__4818__auto___48901)){
args__4824__auto__.push((arguments[i__4819__auto___48902]));

var G__48903 = (i__4819__auto___48902 + (1));
i__4819__auto___48902 = G__48903;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq48749){
var G__48750 = cljs.core.first(seq48749);
var seq48749__$1 = cljs.core.next(seq48749);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48750,seq48749__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___48906 = arguments.length;
var i__4819__auto___48907 = (0);
while(true){
if((i__4819__auto___48907 < len__4818__auto___48906)){
args__4824__auto__.push((arguments[i__4819__auto___48907]));

var G__48908 = (i__4819__auto___48907 + (1));
i__4819__auto___48907 = G__48908;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq48753){
var G__48754 = cljs.core.first(seq48753);
var seq48753__$1 = cljs.core.next(seq48753);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48754,seq48753__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___48911 = arguments.length;
var i__4819__auto___48912 = (0);
while(true){
if((i__4819__auto___48912 < len__4818__auto___48911)){
args__4824__auto__.push((arguments[i__4819__auto___48912]));

var G__48913 = (i__4819__auto___48912 + (1));
i__4819__auto___48912 = G__48913;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq48755){
var G__48756 = cljs.core.first(seq48755);
var seq48755__$1 = cljs.core.next(seq48755);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48756,seq48755__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___48915 = arguments.length;
var i__4819__auto___48916 = (0);
while(true){
if((i__4819__auto___48916 < len__4818__auto___48915)){
args__4824__auto__.push((arguments[i__4819__auto___48916]));

var G__48918 = (i__4819__auto___48916 + (1));
i__4819__auto___48916 = G__48918;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq48757){
var G__48758 = cljs.core.first(seq48757);
var seq48757__$1 = cljs.core.next(seq48757);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48758,seq48757__$1);
}));
...
var temp__5754__auto__ = cljs.core.second(comment_split);
if(cljs.core.truth_(temp__5754__auto__)){
var possible_options = temp__5754__auto__;
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__48768,form){
var vec__48769 = p__48768;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48769,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48769,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48769,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48769,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__48772 = (cljs.core.truth_((function (){var and__4210__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4210__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48772,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48772,(1),null);
...
var G__48921 = cljs.core.next(sos);
var G__48922 = comment_QMARK_;
var G__48923 = (function (){var or__4212__auto__ = (!(empty_string_QMARK_));
if(or__4212__auto__){
return or__4212__auto__;
} else {
...
var G__48924 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__48921;
previous_comment_QMARK_ = G__48922;
start_interpolating_QMARK_ = G__48923;
out = G__48924;
continue;
}
break;
...
try{var vec__48805 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48805,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48805,(1),null);
...
var vec__48808 = (cljs.core.truth_((function (){var or__4212__auto__ = range_start__$1;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48808,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48808,(1),null);
...
var vec__48811 = (cljs.core.truth_((function (){var and__4210__auto__ = actual_start;
if(cljs.core.truth_(and__4210__auto__)){
return actual_end;
} else {
return and__4210__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48811,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48811,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48811,(2),null);
...
var forms = (function (){var G__48829 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__48829) : zprint.zutil.edn_STAR_.call(null,G__48829));
})();
...
var temp__5754__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(fn_spec,key);
if(cljs.core.truth_(temp__5754__auto__)){
var key_spec = temp__5754__auto__;
