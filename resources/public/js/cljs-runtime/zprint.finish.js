...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__45787_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__45787_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__45787_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__45788){
var vec__45789 = p__45788;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45789,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45789,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__45799,s,color,element,idx){
var map__45801 = p__45799;
var map__45801__$1 = cljs.core.__destructure_map(map__45801);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45801__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45801__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45801__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__45819 = (function (){var or__4212__auto__ = color;
...
var fexpr__45818 = (function (){var G__45820 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__45820) : style_map.call(null,G__45820));
})();
return (fexpr__45818.cljs$core$IFn$_invoke$arity$1 ? fexpr__45818.cljs$core$IFn$_invoke$arity$1(G__45819) : fexpr__45818.call(null,G__45819));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__45827){
var vec__45828 = p__45827;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45828,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45828,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45828,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__45832){
var vec__45833 = p__45832;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45833,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45833,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45833,(2),null);
...
var G__46058 = cljs.core.next(ssv);
var G__46059 = (this_ssv == null);
var G__46060 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__46061 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__46058;
doing_nil_QMARK_ = G__46059;
last_elide = G__46060;
out = G__46061;
continue;
}
...
var vec__45860 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45860,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45860,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45860,(2),null);
...
var G__46062 = cljs.core.next(remaining_cvec);
var G__46063 = new_idx;
var G__46064 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__46062;
idx = G__46063;
out = G__46064;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__45911,cursor_vec){
var vec__45912 = p__45911;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45912,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45912,(1),null);
var focus_vec = vec__45912;
...
var vec__45915 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45915,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45915,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__45924){
var vec__45925 = p__45924;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45925,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45925,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__45940,existing_count){
var vec__45942 = p__45940;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45942,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45942,(1),null);
...
return cljs.core.filterv((function (p1__45935_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__45935_SHARP_))));
...
var vec__45969 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45969,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45969,(1),null);
var cvec_element = vec__45969;
if((cvec_element == null)){
var G__46090 = cljs.core.next(cvec_nl);
var G__46091 = (idx + (1));
var G__46092 = start;
var G__46093 = out;
cvec_nl = G__46090;
...
var G__46094 = cljs.core.next(cvec_nl);
var G__46095 = (idx + (1));
var G__46096 = idx;
var G__46097 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__46094;
idx = G__46095;
start = G__46096;
out = G__46097;
...
var G__46099 = cljs.core.next(cvec_nl);
var G__46100 = (idx + (1));
var G__46101 = (idx + (1));
var G__46102 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__46099;
idx = G__46100;
start = G__46101;
out = G__46102;
...
var G__46107 = cljs.core.next(cvec_nl);
var G__46108 = (idx + (1));
var G__46109 = idx;
var G__46110 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__46107;
idx = G__46108;
start = G__46109;
out = G__46110;
...
var G__46111 = cljs.core.next(cvec_nl);
var G__46112 = (idx + (1));
var G__46113 = start;
var G__46114 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__46111;
idx = G__46112;
start = G__46113;
out = G__46114;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__46002_SHARP_,p2__46001_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__46001_SHARP_)){
return cljs.core.reduced(p1__46002_SHARP_);
} else {
return (p1__46002_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__46005,p__46006){
var vec__46007 = p__46005;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46007,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46007,(1),null);
var vec__46010 = p__46006;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46010,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46010,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__46049,cvec,focus_vec){
var map__46051 = p__46049;
var map__46051__$1 = cljs.core.__destructure_map(map__46051);
var options = map__46051__$1;
var map__46052 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46051__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__46052__$1 = cljs.core.__destructure_map(map__46052);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46052__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46052__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46052__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46048_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__46048_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
