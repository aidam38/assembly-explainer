...
var temp__5752__auto__ = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(loc) : f.call(null,loc));
if(cljs.core.truth_(temp__5752__auto__)){
var n = temp__5752__auto__;
var G__47237 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__47237;
continue;
} else {
var G__47239 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__47239;
continue;
}
} else {
var G__47240 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__47240;
continue;
}
}
...
var G__47185 = zloc;
var G__47186 = (function (){var G__47187 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__47188 = zloc;
var G__47188__$1 = (((G__47188 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__47188) : rewrite_clj.zip.node.call(null,G__47188)));
if((G__47188__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47188__$1) : zprint.zutil.edn_STAR_.call(null,G__47188__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__47187) : rewrite_clj.zip.root.call(null,G__47187));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__47185,G__47186) : rewrite_clj.zip.replace.call(null,G__47185,G__47186));
});
/**
...
var G__47243 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__47243;
continue;
}
break;
...
var G__47244 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__47245 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__47244;
out = G__47245;
continue;
} else {
...
var G__47247 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__47248 = cljs.core.next(new_loc);
var G__47249 = replaced_loc;
nloc = G__47247;
new_loc = G__47248;
last_loc = G__47249;
continue;
...
return zprint.rewrite.sort_val((function (){var G__47228 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__47228) : rewrite_clj.zip.down.call(null,G__47228));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__47231_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__47231_SHARP_) : rewrite_clj.zip.tag.call(null,p1__47231_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__47231_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__47231_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
