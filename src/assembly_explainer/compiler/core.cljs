...
(defn init-program-state [program-input]
  (r/atom {:registers {:rip 0 :rsp 0 :rbp 0 :rax 0 :rbx 0 :rcx 0 :rdx 0 :rsi 0 :rdi 0 :flags 0}
           :memory {:program {:instructions (parse program-input)}
                    :stack (vec (repeat 20 nil))}}))
...
(comment
  ...
  (def program-state (r/atom {:registers {:rip 0 :rsp 19 :rbp 0 :rax 0 :rbx 0 :rcx 0 :rdx 0 :rsi 0 :rdi 0 :flags 0}
                              :memory {:program {:instructions [["mov" [:literal "1"] [:register :rbp]]]}
                                       :stack (vec (repeat 20 0))}}))
